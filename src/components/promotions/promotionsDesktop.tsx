            ...
            <Slide
                ...
                <Box className='promotionsSlider' >
                    {show && <Fade bottom big>
                        <Box className='promotionsText'>
                            ...
                            <Button variant='contained'
                                className='promotionsBtn' >Shop now</Button>
                        </Box>
                    </Fade>}
                    {show &&
                        <Box className='promotionsOffer' >
                            <Box >
                                <Image className={classes.animation} src={'/50off2.png'} alt='img1' width={150} height={150} />
                            </Box>
                    ...
                    <Box className='promotionsImgContainer'>
                        <Image src={itemData[itemIndex].img} alt='img1' width={1300}
                            height={500} />
                    </Box>
                </Box>
            </Slide>
