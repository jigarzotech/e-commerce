    ...
    return (
        <Box className='bannerContainer'>
            <Grid container
                ...
                <Grid item xs={12} sm={12} md={4} display="flex" flexDirection={'column'} alignItems="center">
                ...
                <Grid item xs={12} sm={12} md={4} display="flex" flexDirection={'column'} alignItems="center">
                    <Box className='banner' sx={{ backgroundImage: `url(${'/womenBanner.jpg'})`, }}>
                        <Box className='bannerItem'>
                ...
                <Grid item xs={12} sm={12} md={4} display="flex" flexDirection={'column'} alignItems="center">
                    <Box className='banner' sx={{ backgroundImage: `url(${'/kidBanner.jpg'})`, }}>
                        <Box className='bannerItem'>
