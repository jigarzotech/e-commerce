        ...
        <Slider {...settings}>
            {
                filterData.map((item, index) => (
                    <Box className='slider' key={index}
                        ...
                        sx={{ padding: matchesForSM ? '0px 10px' : matches ? '0px' : '0px 10px' }}
                        onMouseEnter={() => {
                            setShowOptions(true)
                            setItemIndex(index)
                        }}
                    ...
                    >
                        ...
                        <Typography variant='subtitle1' color={Colors.dim_grey} mt={2}
                            sx={{ textTransform: 'capitalize' }}>{item.category}</Typography>
                        <Typography variant='h5' color={Colors.black} sx={{ textTransform: 'capitalize' }}>{item.title}</Typography>
