    ...
    const FAQsData: {
        ...
        answer: string;
            ...
            },
            {
                ...
                answer: 'Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
            },
            {
                question: 'Where Can I Find The Wall Street Journal?',
                answer: 'Quis nostrud exercitation lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
            },
        ]
    ...
    return (
        <Box className='faqs'>
            {FAQsData.map((item, index) => (
                ...
                <Box key={index}>
                    <Box className='faqsQuestion' onClick={() => {
                        setIndexItem(index)
                        index === indexItem ?
                    ...
                    {index === indexItem && show &&
                        <Fade big cascade>
                            <Typography className='faqsAnswer'>
                                {item.answer}
                            </Typography>
                        </Fade>
                    }
